        ...
        <div class="faq-block">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Мерч — это вещи с логотипом, которые превращают фанатов в «живую рекламу». Для бренда это способ
                        заработать и заявить о себе, а для человека — возможность показать, чей он единомышленник. Это
                        не просто футболка или кружка, а материальный символ верности вашим идеям. Короче говоря: это
                        способ носить любимые смыслы на себе.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Выбирайте всё, что душе угодно :)</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Пока что мы занимаемся только вышивкой.</p>
                </div>
            </div>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-item">
                        ...
                        <a class="footer-link" href="tel:+79207668888"><br>+7-920-766-88-88</a>
                    </div>
                    <div class="footer-item">
                        <span>Почта:</span>
